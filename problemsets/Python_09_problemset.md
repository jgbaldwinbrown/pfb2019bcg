...
2. Write a script that takes a multi-FASTA file [Python_09.fasta](https://raw.githubusercontent.com/prog4biol/pfb2018/master/files/Python_09.fasta) from user input and breaks each sequence into codons (every three nucleotides is a codon) in just the first reading frame. Your output should look like this 
```
seq1-frame-1-codons
CAT GCT TGA GTC
``` 
